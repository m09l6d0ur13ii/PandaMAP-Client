...
UUID(NETMSG_IAMRUSHIE, "iamrushie@rushieclient.github.io")
UUID(NETMSG_RUSHIE_CHECKSUM_REQUEST, "checksum-request@rushieclient.github.io")
UUID(NETMSG_RUSHIE_CHECKSUM_RESPONSE, "checksum-response@rushieclient.github.io")
