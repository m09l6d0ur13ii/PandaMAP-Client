...
UUID(NETMSG_IAMRUSHIE, "iamrushie@rushie-client.ru")
UUID(NETMSG_RUSHIE_CHECKSUM_REQUEST, "checksum-request@rushie-client.ru")
UUID(NETMSG_RUSHIE_CHECKSUM_RESPONSE, "checksum-response@rushie-client.ru")
